...
namespace Nafadh_Backend.Repositories
{
    public class TraineeRepository : ITraineeRepository
    {
            ...
            int pageNumber, int pageSize)
        {
            ...
            // 👈 التعديل هنا: الفلترة تتفعل لكل القيم (0, 1, 2) طالما status ليست null
            if (status.HasValue)
            {
            ...
            {
                query = query.Where(t =>
                    (t.User != null && t.User.FullName != null && t.User.FullName.Contains(searchTerm)) ||
                    (t.User != null && t.User.Email != null && t.User.Email.Contains(searchTerm)) ||
                    (t.Major != null && t.Major.Contains(searchTerm)) ||
                    (t.University != null && t.University.Contains(searchTerm))
                );
            }

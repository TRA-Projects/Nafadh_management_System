...
namespace Nafadh_Backend.Repositories
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        {
            // الربط الصحيح تماماً مثل استعلام الـ SQL لضمان جلب كل التسجيلات والدفعات التابعة لبرامج الشركة
            var links = from c in _context.NFD_Companies
                        join cp in _context.NFD_CompanyPrograms on c.CompanyId equals cp.CompanyId
                        join b in _context.NFD_Batches on cp.ProgramId equals b.ProgramId
                        join e in _context.NFD_Enrollments on b.BatchId equals e.BatchId
                        select new CompanyEnrollmentLinkDTO
                        {
            ...
            return await links.Distinct().ToListAsync();
        }
        // Delete Company

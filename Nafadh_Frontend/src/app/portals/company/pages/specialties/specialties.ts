...
export class CompanySpecialties implements OnInit {
  ...
  // خريطة الألوان الخاصة بالتخصصات المختلفة لضمان تعدد الألوان في الدائرة
  readonly departmentColors: { [key: string]: string } = {
    'تقنية المعلومات': '#00338d',
    'العمليات والتحليل': '#007cae',
    'التصميم الرقمي': '#efbb20',
    'أمن المعلومات': '#8b5cf6',
    'الذكاء الاصطناعي': '#1ebbf0'
  };
